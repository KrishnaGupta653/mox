# Final NPM Publish Checklist for mox v7.2.2
...
See `PRE_PUBLISH_FIXES_v7.2.2.md` for detailed fix documentation.
...
# Test basic commands
./mox version       # Should show version 7.2.2
...
### Version Check
- [ ] Verify `package.json` version is `7.2.2`
- [ ] Verify `VERSION` file contains `7.2.2`
- [ ] Verify `mox --version` outputs `7.2.2`

### Documentation
- [ ] README.md is up to date
- [ ] CHANGELOG.md includes v7.2.2 changes
...
2. Clean install works: `npm install -g mox-cli@7.2.2`
...
npm deprecate mox-cli@7.2.2 "Critical issue found, use 7.2.1 instead"
...
*Checklist last updated: 2026-06-04*
*Version: 7.2.2*
